...
export default function Header({ onOpenLogin, onOpenCreateSeries }) {
      ...
      <div style={styles.actions}>
        {user ? (
          <>
            ...
            <button style={styles.btn} onClick={onOpenCreateSeries}>Dodaj serię</button>
            <button style={styles.btnOutline} onClick={logout}>Wyloguj</button>
          </>
        ) : (
          <button style={styles.btn} onClick={onOpenLogin}>Zaloguj</button>
        )}
      </div>
    </header>
  );
